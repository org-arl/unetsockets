...
const cjs_includes = [
  'const { UnetSocket, Services, AgentID, Gateway, Protocol, UnetMessages, UnetTopics, toGps, toLocal} = require(\'../../dist/cjs/unet.cjs\');',
...
const esm_includes = [
  'import { UnetSocket, Services, AgentID, Gateway, Protocol, UnetMessages, UnetTopics, toGps, toLocal } from \'../../dist/esm/unet.js\';',
